...
This repository contains artifacts for the paper: "OVERTON: Misbehavior Detection and Trust in Vehicular Networks" submitted at the 33rd USENIX Security Symposium (USENIX 2024). The artifacts include OVERTON source code and data paths with sample datasets for parsing traffic data and running the framework.
